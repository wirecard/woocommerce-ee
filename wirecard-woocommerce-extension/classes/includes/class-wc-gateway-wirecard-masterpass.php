...
class WC_Gateway_Wirecard_Masterpass extends WC_Wirecard_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'heading_title_masterpass', 'wirecard-woocommerce-extension' );
		$this->method_name        = __( 'masterpass', 'wirecard-woocommerce-extension' );
		$this->method_description = __( 'masterpass_desc', 'wirecard-woocommerce-extension' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'             => array(
				...
				'type'        => 'checkbox',
				'label'       => __( 'enable_heading_title_masterpass', 'wirecard-woocommerce-extension' ),
				'description' => __( 'config_status_desc_masterpass', 'wirecard-woocommerce-extension' ),
				'default'     => 'no',
			),
			'title'               => array(
				...
				'default'     => __( 'heading_title_masterpass', 'wirecard-woocommerce-extension' ),
			),
