	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'             => array(
				...
				'type'        => 'checkbox',
				'description' => __( 'Activate payment method Unionpay International', 'wirecard-woocommerce-extension' ),
				'label'       => __( 'Enable Wirecard Unionpay International', 'wirecard-woocommerce-extension' ),
				'default'     => 'no',
			),
			'title'               => array(
				...
				'default'     => __( 'Wirecard Unionpay International', 'wirecard-woocommerce-extension' ),
			),
