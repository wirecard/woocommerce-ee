...
require_once __DIR__ . '/../../../../classes/includes/class-wc-gateway-wirecard-eps.php';

class WC_Gateway_Wirecard_Eps_Utest extends \PHPUnit_Framework_TestCase {

	/** @var WC_Gateway_Wirecard_Eps */
	private $payment;
