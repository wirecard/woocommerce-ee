...
require_once __DIR__ . '/../../../../classes/includes/class-wc-gateway-wirecard-wechat.php';

use Wirecard\PaymentSdk\Transaction\WeChatTransaction;

class WC_Gateway_Wirecard_WeChat_Utest extends \PHPUnit_Framework_TestCase {

	/** @var WC_Gateway_Wirecard_WeChat */
	private $payment;

	public function setUp() {
		$this->payment = new WC_Gateway_Wirecard_WeChat();
	}
	...
	public function test_process_cancel() {
		$this->assertNotNull( $this->payment->process_cancel( 12 ) );
	}
}
