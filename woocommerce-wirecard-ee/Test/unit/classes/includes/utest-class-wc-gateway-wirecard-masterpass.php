...
require_once __DIR__ . '/../../../../classes/includes/class-wc-gateway-wirecard-masterpass.php';

class WC_Gateway_Wirecard_Masterpass_Utest extends \PHPUnit_Framework_TestCase {

	/** @var WC_Gateway_Wirecard_Masterpass */
	private $payment;

	public function setUp() {
		$this->payment = new WC_Gateway_Wirecard_Masterpass();
	}
